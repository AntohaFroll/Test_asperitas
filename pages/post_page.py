...
class PostPage(BasePage):
    def create_text_post(self, generate_text):
        ...
        assert self.wait_element_present(*PostPageLocators.TITLE_POST), "Post not created!"

    def delete_post(self):
        self.driver.find_element(*BasePageLocators.USERNAME_LINK).click()
        self.wait_element_present(*PostPageLocators.TITLE_POST_TEXT)
        self.driver.find_element(*PostPageLocators.TITLE_POST_TEXT).click()
        self.wait_element_present(*PostPageLocators.DELETE_BUTTON)
        self.driver.find_element(*PostPageLocators.DELETE_BUTTON).click()
        assert self.wait_element_present(*PostPageLocators.EMPTY_POST_LIST_LABEL), "Post not deleted!"
